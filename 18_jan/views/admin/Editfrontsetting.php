...
?>
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().$control.'/update'.$controlname.'/'; ?><?php if(isset($frontsetting[0]->id)) { echo $frontsetting[0]->id; } ?>" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Name" class="form-control" id="title" name="title" value="<?php  if(isset($frontsetting[0]->$title)) { echo $frontsetting[0]->$title; } ?>">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Website Title" class="form-control" id="wtitle" name="wtitle" value="<?php  if(isset($frontsetting[0]->$wtitle)) { echo $frontsetting[0]->$wtitle; } ?>">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Footer" class="form-control" id="copyright" name="copyright" value="<?php if(isset($frontsetting[0]->$copyright)) { echo $frontsetting[0]->$copyright; } ?>">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input  type="text" placeholder="Best Regard Message" class="form-control" id="best" name="best" value="<?php if(isset($frontsetting[0]->best)) { echo $frontsetting[0]->best; } ?>">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Support Email" class="form-control" id="support" name="support" value="<?php if(isset($frontsetting[0]->support)) { echo $frontsetting[0]->support; } ?>">
						 ...
						 <div class="form-group">
							...
							<div class="col-md-8">
								<textarea  placeholder="Support Message" class="form-control" id="supportmsg" name="supportmsg"><?php if(isset($frontsetting[0]->supportmsg)) { echo $frontsetting[0]->supportmsg; } ?></textarea>
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<textarea  placeholder="Footer Description" class="form-control" id="meta" name="meta"><?php if(isset($frontsetting[0]->$meta)) { echo $frontsetting[0]->$meta; } ?></textarea>
						...
						<div class="form-group">
							...
							<input value="<?php if(isset($frontsetting[0]->logo)) { echo $frontsetting[0]->logo; } ?>" type="hidden" id="logo1" name="logo1"/>

							</div>
							<div class="col-md-4" id="showphoto">
							<?php if(isset($frontsetting[0]->logo)) {
								if($frontsetting[0]->logo!="")
								{ ?>
							<a href="<?php echo base_url(); ?>images/<?php echo $frontsetting[0]->logo;  ?>" data-lightbox="example-set"><img src="<?php echo base_url(); ?>images/<?php echo $frontsetting[0]->logo;  ?>"></a>
							<?php } } ?>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5" style="padding: 6px;">
							<a href="#" data-toggle="modal" data-target="#myModalphoto2" class="btn btn-primary">Browse</a>
							<input type="hidden" name="favicon" id="favicon">
							<input value="<?php if(isset($frontsetting[0]->favicon)) { echo $frontsetting[0]->favicon; } ?>" type="hidden" id="favicon1" name="favicon1"/>

							</div>
							<div class="col-md-4">
							<?php if(isset($frontsetting[0]->favicon)) {
								if($frontsetting[0]->favicon!="")
								{ ?>
							<a href="<?php echo base_url(); ?>images/<?php echo $frontsetting[0]->favicon;  ?>" data-lightbox="example-set"><img src="<?php echo base_url(); ?>images/<?php echo $frontsetting[0]->favicon;  ?>"></a>
							<?php } } ?>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Paypal Email" class="form-control" id="pemail" name="pemail" value="<?php if(isset($paypal[0]->email)) { echo $paypal[0]->email; } ?>">
...
<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Paypal Url" class="form-control" id="purl" name="purl" value="<?php if(isset($paypal[0]->url)) { echo $paypal[0]->url; } ?>">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-4" >
                            ...
                            <input type="file" name="ophoto" id="upload1">
								<input type="hidden" name="ophoto1" value="<?php if(isset($frontsetting[0]->ophoto)) { echo $frontsetting[0]->ophoto; } ?>">
                            <br/>
