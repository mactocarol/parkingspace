					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <div class="pad-hor mar-top">
					                <h2 class="text-thin mar-no"><i class="text-info text-normal">Parking owner Details</i>
									<a href="<?php echo base_url(); ?>Manageparkingowner/user" class="btn btn-warning pull-right">Back</a>
									</h2>					               
					            </div>
