					    ...
					    <div class="panel">
					        <div class="panel-body">
					            <div class="pad-hor mar-top">
					                <h2 class="text-thin mar-no"><i class="text-info text-normal">Membership Payment Details</i>
									<a href="<?php echo base_url(); ?>Payment/membershippayment" class="btn btn-warning pull-right">Back</a>
									</h2>					               
					            </div>
								   ...
								   <li class="list-group-item list-item-lg media">
					                   ...
					                   <a href="<?php echo base_url(); ?>upload/user/<?php echo $featured[0]->photo;  ?>" data-lightbox="example-set"> <img class="img-lg" alt="Image" src="<?php echo base_url(); ?>upload/user/<?php echo $featured[0]->photo; ?>"></a>
                                        ...
                                        <p class="text-sm">Last Updated Date: <?php if(isset($featured[0]->updated_dt)) { echo $featured[0]->updated_dt; } ?></p>
										 ...
										 <p class="text-sm">Expired date : <?php if(isset($featured[0]->mdate)) { echo date("Y-m-d H:i:s",strtotime("+".$featured[0]->duration,strtotime($featured[0]->mdate))); } ?></p>
					                ...
					                <li class="list-group-item list-item-lg">
					                   <div class="media-heading">
					                        <span class="viewheading"> Package Title:</span> <a class=" text-lg text-semibold" href="#" data-toggle="modal"><?php if(isset($featured[0]->title)) { echo $featured[0]->title; } ?></a>
					                   </div>
					                </li>
									<li class="list-group-item list-item-lg">
					                   <div class="media-heading">
									...
									<li class="list-group-item list-item-lg">
					                   <div class="media-heading">
					                        <span class="viewheading"> Validity:</span> <a class=" text-lg text-semibold" href="#" data-toggle="modal"><?php if(isset($featured[0]->duration)) { echo $featured[0]->duration; } ?></a>
					                   </div>
					                </li>
									<li class="list-group-item list-item-lg">
					                   <div class="media-heading">
									...
									<li class="list-group-item list-item-lg">
					                   <div class="media-heading">
					                        <span class="viewheading"> Description:</span> <a class=" text-lg text-semibold" href="#" data-toggle="modal"><?php if(isset($featured[0]->paypal)) { echo $featured[0]->paypal; } ?></a>
					                   </div>
					                </li>
