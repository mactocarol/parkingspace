					...
					<div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().$control.'/update'.$controlname.'/'; ?><?php if(isset($timezone[0]->id)) { echo $timezone[0]->id; } ?>" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
					                <div class="panel-body">
					                    
					                   
                        <div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Timezone Name</label>
							<div class="col-md-8">
								<input type="text" placeholder="Name" class="form-control" id="title" name="title" value="<?php  if(isset($timezone[0]->name)) { echo $timezone[0]->name; } ?>">
								<div class="errors"><?php echo form_error('title'); ?></div>		
							</div>
						</div>
						
						 <div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Timezone Value</label>
							<div class="col-md-8">
								<input type="text" placeholder="value" class="form-control" id="valu" name="valu" value="<?php  if(isset($timezone[0]->valu)) { echo $timezone[0]->valu; } ?>">
								<div class="errors"><?php echo form_error('valu'); ?></div>		
							</div>
						</div>
