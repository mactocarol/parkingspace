		...
		<?php } ?>   
					...
					<div class="row">
					    ...
					    <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Price" class="form-control" id="title" name="title" value="<?php  if(isset($_REQUEST['title'])) { echo $_REQUEST['title']; } ?>">
  ...
  <div class="form-group">
							...
							<div class="col-md-8">
								...
								<option value="Percentage" <?php if(isset($_REQUEST['type'])) { if($_REQUEST['type']=='Percentage') { echo "selected"; } } ?>>Percentage</option>
								<option value="Fixed" <?php if(isset($_REQUEST['type'])) { if($_REQUEST['type']=='Fixed') { echo "selected"; } } ?>>Fixed</option>
								</select>
