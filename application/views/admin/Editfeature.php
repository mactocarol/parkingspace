					...
					<div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().$control.'/update'.$controlname.'/'; ?><?php if(isset($feature[0]->id)) { echo $feature[0]->id; } ?>" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
					                <div class="panel-body">
					    <div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Title</label>
							<div class="col-md-8">
								<input type="text" placeholder="Title" class="form-control" id="title" name="title" value="<?php  if(isset($feature[0]->title)) { echo $feature[0]->title; } ?>">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Name" class="form-control" id="name" name="name" value="<?php  if(isset($feature[0]->name)) { echo $feature[0]->name; } ?>">
						 ...
						 <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="No" class="form-control" id="no" name="no" value="<?php  if(isset($feature[0]->no)) { echo $feature[0]->no; } ?>">
								<div class="errors"><?php echo form_error('no'); ?></div>		
							</div>
						</div>  
