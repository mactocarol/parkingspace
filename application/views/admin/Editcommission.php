					...
					<div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().$control.'/update'.$controlname.'/'; ?><?php if(isset($commission[0]->id)) { echo $commission[0]->id; } ?>" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Price" class="form-control" id="title" name="title" value="<?php  if(isset($commission[0]->price)) { echo $commission[0]->price; } ?>">
						 ...
						 <div class="form-group">
							...
							<div class="col-md-8">
								...
								<option value="Percentage" <?php if(isset($commission[0]->type)) { if($commission[0]->type=='Percentage') { echo "selected"; } } ?>>Percentage</option>
								<option value="Fixed" <?php if(isset($commission[0]->type)) { if($commission[0]->type=='Fixed') { echo "selected"; } } ?>>Fixed</option>
								</select>
