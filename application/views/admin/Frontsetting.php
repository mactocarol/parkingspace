					        ...
					        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
					            <thead>
									...
									<?php 
										...
										{
											foreach($frontsetting as $list)
											{
											$logo =$list->logo;
											$favicon =$list->favicon;
										...
										<tr class="gradeX">
											...
											<?php } else { ?>
											<a href="<?php echo base_url(); ?>images/<?php echo $list->ophoto; ?>" data-lightbox="example-set">
												<img src="<?php echo base_url(); ?>images/<?php echo $logo; ?>" class="img-thumbnail" >
											</a>
											<?php } ?>
											</td>
											<td>
											...
											<?php } else { ?>
											<a href="<?php echo base_url(); ?>images/<?php echo $favicon; ?>" data-lightbox="example-set">
												<img src="<?php echo base_url(); ?>images/<?php echo $favicon; ?>" class="img-thumbnail" >
											</a>
											<?php } ?>
											</td>
											<td><a class="btn-link text-semibold" href="<?php echo base_url().$control.'/view'.$controlname.'/'.$list->id; ?>"><?php echo $list->$title; ?></a></td>
