					...
					<div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().$control.'/update'.$controlname.'/'; ?><?php if(isset($privacy[0]->id)) { echo $privacy[0]->id; } ?>" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
					                <div class="panel-body">
					    <div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Title</label>
							<div class="col-md-8">
								<input type="text" placeholder="Title" class="form-control" id="title" name="title" value="<?php  if(isset($privacy[0]->title)) { echo $privacy[0]->title; } ?>">
								<div class="errors"><?php echo form_error('title'); ?></div>		
							</div>
						</div> 

<div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Sub Title</label>
							<div class="col-md-8">
								<input type="text" placeholder="Sub title" class="form-control" id="subtitle" name="subtitle" value="<?php  if(isset($privacy[0]->subtitle)) { echo $privacy[0]->subtitle; } ?>">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<textarea rows=8 cols=10  placeholder="Description" class="form-control" id="description" name="description"><?php  if(isset($privacy[0]->description)) { echo $privacy[0]->description; } ?></textarea>
