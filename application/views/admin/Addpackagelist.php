		...
		<?php } ?>   
					...
					<div class="row">
                       ...
                       <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Price" class="form-control" id="price" name="price" value="<?php  if(isset($_REQUEST['price'])) { echo $_REQUEST['price']; } ?>">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Validity" class="form-control" id="validity" name="validity" value="<?php  if(isset($_REQUEST['validity'])) { echo $_REQUEST['validity']; } ?>">
...
<div class="form-group">
						...
						{						
					    ?>
                        <option value="<?php echo $f->id; ?>" <?php if(isset($_REQUEST['feature'])) { if($_REQUEST['feature']==$f->id) { echo "selected"; } } ?>><?php echo $f->title; ?></option>
						<?php } } ?>
						</select>
