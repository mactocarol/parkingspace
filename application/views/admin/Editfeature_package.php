					...
					<div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().$control.'/update'.$controlname.'/'; ?><?php if(isset($feature_package[0]->id)) { echo $feature_package[0]->id; } ?>"" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
					                <div class="panel-body">
					    <div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Validity</label>
							<div class="col-md-8">
								<input type="text" placeholder="Validity" class="form-control" id="days" name="days" value="<?php  if(isset($feature_package[0]->days)) { echo $feature_package[0]->days; } ?>">
								<div class="errors"><?php echo form_error('days'); ?></div>		
							    <b>Enter validity in days,months,weeks,years like 2 days,2 week etc </b>
							</div>
						</div>
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Price" class="form-control" id="price" name="price" value="<?php  if(isset($feature_package[0]->price)) { echo $feature_package[0]->price; } ?>">
