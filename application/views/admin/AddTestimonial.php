					...
					<div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().'Admin/create'.$controlname; ?>" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Location</label>
							<div class="col-md-8">
								<input type="text" placeholder="Location" class="form-control" id="title" name="location" value="<?php  if(isset($_REQUEST['title'])) { echo $_REQUEST['title']; } ?>">
								<div class="errors"><?php echo form_error('title'); ?></div>		
							</div>
						</div>  
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<textarea  placeholder="Message" class="form-control" id="description" name="description"><?php  if(isset($_REQUEST['description'])) { echo $_REQUEST['description']; } ?></textarea>
