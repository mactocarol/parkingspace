...
<?php								
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="company name" class="form-control" id="companyname" name="companyname" value="<?php  if(isset($_REQUEST['companyname'])) { echo $_REQUEST['companyname']; } ?>">
						...
						<select data-size="7" data-live-search="true" class="selectpicker  fill_selectbtn_in own_selectbox" data-title="broker type" name="brokertype" id="brokertype" data-width="100%">
                        <?php
						if(isset($brokertype))
						{
                        foreach($brokertype as $po)
						{						
					    ?>
                        <option value="<?php echo $po->id; ?>" <?php if(isset($_REQUEST['brokertype'])) { if($_REQUEST['brokertype']==$po->id) { echo "selected"; } } ?>><?php echo $po->name; ?></option>
						<?php } } ?>
						</select>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="advanced_search_row">
						<select data-size="7" data-live-search="true" class="selectpicker  fill_selectbtn_in own_selectbox" data-title="expertise" multiple name="speciality[]" id="speciality" data-width="100%">
                        <?php
						if(isset($propertytype))
						{
                        foreach($propertytype as $po)
						{						
					    ?>
                        <option value="<?php echo $po->id; ?>" <?php if(isset($_REQUEST['speciality'])) { if($_REQUEST['speciality']==$po->id) { echo "selected"; } } ?>><?php echo $po->name; ?></option>
						<?php } } ?>
						</select>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="advanced_search_row">
						<select data-size="7" data-live-search="true" class="selectpicker  fill_selectbtn_in own_selectbox" data-title="language spoken" multiple name="languagespoken[]" id="languagespoken" data-width="100%">
                        <?php
						if(isset($languagespoken))
						{
                        foreach($languagespoken as $po)
						{						
					    ?>
                        <option value="<?php echo $po->id; ?>" <?php if(isset($_REQUEST['languagespoken'])) { if($_REQUEST['languagespoken']==$po->id) { echo "selected"; } } ?>><?php echo $po->name; ?></option>
						<?php } } ?>
						</select>
