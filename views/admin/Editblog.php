					...
					<div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <!--Input Size-->
					            <!--===================================================-->
					            <form action="<?php echo base_url().$control.'/update'.$controlname.'/'; ?><?php if(isset($blog[0]->id)) { echo $blog[0]->id; } ?>" id="valid-form" class="form-horizontal" method="post" enctype="multipart/form-data">
					                <div class="panel-body">
					    <div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Title</label>
							<div class="col-md-8">
								<input type="text" placeholder="Name" class="form-control" id="title" name="title" value="<?php  if(isset($blog[0]->title)) { echo $blog[0]->title; } ?>">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<textarea  placeholder="Description" class="form-control" id="description" name="description"><?php  if(isset($blog[0]->description)) { echo $blog[0]->description; } ?></textarea>
 ...
 <!--<div class="form-group">
						...
						{						
					    ?>
                        <option value="<?php echo $u->id; ?>" <?php if(isset($blog[0]->uid)) { if($blog[0]->uid==$u->id) { echo "selected"; } } ?>><?php echo $u->name; ?></option>
						<?php } } ?>
						</select>
...
<!--<div class="form-group">
						...
						{						
					    ?>
                        <option value="<?php echo $f->id; ?>" <?php if(isset($blog[0]->category)) { if(in_array($f->id,explode( ",",$blog[0]->category))) { echo "selected"; } } ?>><?php echo $f->name; ?></option>
						<?php } } ?>
						</select>
						...
						<label class="col-md-3 control-label" for="inputDefault">Photo</label>
							...
							<input type="hidden" name="photo1" id="photo1" value="<?php if(isset($blog[0]->photo)) { echo $blog[0]->photo; } ?>">
							</div>
							<div class="col-md-3" id="showphoto">
							<?php if(isset($blog[0]->photo)) {
								if($blog[0]->photo!="")
								{ ?>
							<a href="<?php echo base_url(); ?>upload/blog/<?php echo $blog[0]->photo;  ?>" data-lightbox="example-set"><img class="ephoto" src="<?php echo base_url(); ?>upload/blog/<?php echo $blog[0]->photo;  ?>"></a>
							<?php } } ?>
							</div>
						</div>  						
      ...
      <div class="modal-body">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-12" >
							...
							<input type="hidden" name="ophoto1" value="<?php if(isset($blog[0]->ophoto)) { echo $blog[0]->ophoto; } ?>">
                            <br/>
