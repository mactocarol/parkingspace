		...
		<?php } ?>   
					...
					<div class="row">
					    ...
					    <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Title" class="form-control" id="title" name="title" value="<?php  if(isset($_REQUEST['title'])) { echo $_REQUEST['title']; } ?>">
...
<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" placeholder="Sub title" class="form-control" id="subtitle" name="subtitle" value="<?php  if(isset($_REQUEST['subtitle'])) { echo $_REQUEST['subtitle']; } ?>">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-8">
								<textarea rows=8 cols=10  placeholder="Description" class="form-control" id="description" name="description"><?php  if(isset($_REQUEST['description'])) { echo $_REQUEST['description']; } ?></textarea>
