...
<div class="form-group">
							...
							<div class="col-md-9">
							  <input class="form-control" name="name" id="name" type="text" placeholder="Enter coupon name" value="<?php  if(isset($_REQUEST['name'])) { echo $_REQUEST['name']; } ?>" >
							...
							<div class="col-md-9">
							  ...
							  <option value="1" <?php  if(isset($_REQUEST['type'])) { if($_REQUEST['type']==1) { echo "selected"; } } ?>>Percentage</option>
							  <option value="2" <?php  if(isset($_REQUEST['type'])) { if($_REQUEST['type']==2) { echo "selected"; } } ?>>Fixed</option>
							  </select>
						  ...
						  <div class="form-group">
							...
							<div class="col-md-9">
							  <input class="form-control" name="price" id="price" type="text" placeholder="Enter coupon price" value="<?php  if(isset($_REQUEST['price'])) { echo $_REQUEST['price']; } ?>" >
