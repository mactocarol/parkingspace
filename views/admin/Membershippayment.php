...
<div class="col-md-12 searchform">
		...
		<input class="form-control" type="text" id="title" name="title" value="<?php if(isset($_REQUEST['title'])) { echo $_REQUEST['title']; }  ?>" placeholder="title" />      		  
		</div>
		<div class="col-md-4 form-group">
					        ...
					        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tfoot>
									...
									<?php 
										...
										{
											foreach($membershippayment as $list)
											{
